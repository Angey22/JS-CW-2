...
//! Пример вывода "undefined" в консоль, в результате работы функций, у которых нет явно прописанного "return".
// 1-й вариант
console.log('"console.log(f_A())" =>', f_A());
