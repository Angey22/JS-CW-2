...
// Цикл "for...of" по своей синтаксической структуре является менее "декларативным" (в нем меньше используется описательных - декларативных правил: "с чего начинать", "где заканчиваться" и т.д.), чем цыкл "if". В его основу входят два элемента: 1) сам массив который подлежит обработке; 2) служебная переменная в которую записывается каждый последующий элемент обрабатываемого элемента массива.
